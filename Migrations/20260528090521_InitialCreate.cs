        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParkingLotLotId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Slots", x => x.SlotId);
                    table.ForeignKey(
                        name: "FK_Slots_ParkingLots_ParkingLotLotId",
                        column: x => x.ParkingLotLotId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Slots_ParkingLotLotId",
                table: "Slots",
                column: "ParkingLotLotId");
        }
